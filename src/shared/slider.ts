...
export const heroSlides = [
  {
    ...
    productPrice: 16500,
    productPublisher: "Ashton, Edward",
    ...
    },
    {
        ...
        productName: "급류",
        productPrice: 12600,
        productPublisher: "정대건",
        productAuthorName: "믿음사",
        productDescription: "“너 소용돌이에 빠지면 어떻게 해야 하는 줄 알아?수면에서 나오려 하지 말고 숨 참고 밑바닥까지 잠수해서 빠져나와야 돼.”상처에 흠뻑 젖은 이들이 각자의 몸을 말리기까지,서로의 흉터를 감싸며 다시 무지개를 보기까지거센 물살 같은 시간 속에서 헤엄치는 법을 알아내는연약한 이들의 용감한 성장담, 단 하나의 사랑론2020년 《한경신춘문예》에 장편소설 『GV 빌런 고태경』이 당선되어 작품 활동을 시작한 소설가 정대건의 두 번째 장편소설 『급류』가 오늘의 젊은 작가 시리즈 40번으로 출간되었다. 『급류』는 저수지와 계곡이 유명한 지방도시 ‘진평’을 배경으로, 열일곱 살 동갑내기인 ‘도담’과 ‘해솔’의 만남과 사랑을 그린 소설이다. 아빠와 함께 수영을 하러 갔던 도담이 한눈에 인상적인 남자아이 ‘해솔’이 물에 빠질 뻔한 것을 구하러 뛰어들며 둘의 인연은 시작된다. 운명적이고 낭만적으로 보이는 첫 만남 이후 둘은 모든 걸 이야기하고 비밀 없는 사이가 되지만, 그 첫사랑이 잔잔한 물처럼 평탄하지만은 않다. 모르는 사이에 디뎌 빠져나올 수 없이 빨려드는 와류처럼 둘의 관계는 우연한 사건으로 다른 국면을 맞이한다. 도담과 해솔의 관계가 연인으로 발전하던 어느 날, 해솔의 엄마와 도담의 아빠가 불륜 관계인 듯한 정황이 드러나고 이에 화가 난 도담은 그 둘이 은밀히 만나기로 한 날 밤 랜턴을 들고 그들의 뒤를 밟는다. 그리고 그곳에서 생각지도 못한 사고가 벌어진다. 그날 이후, 진평에서 오직 서로가 전부이던, 나누지 못할 비밀이 없던 도담과 해솔의 관계와 삶은 순식간에 바뀌어 버린다. 해솔의 엄마와 도담의 아빠는 어떤 관계였던 걸까? 그 날, 그 밤 도담과 해솔은 어떤 일을 겪게 된 걸까?",
      },
      {
        id: "LwDrHQE8ZUayxeoCQIUM",
        productImage: ghost,
        productName: "주술회전",
        productPrice: 5400,
        productPublisher: "Gege Akutami",
        productAuthorName: "서울미디어코믹스(서울문화사)",
        productDescription: "주인공 이타도리 유지는 평범한 고등학생으로, 친구들과 함께 초자연적인 사건에 휘말리게 된다. 그는 우연히 강력한 저주 '양면 스쿠나'의 손가락을 삼키고 저주의 힘을 얻게 된다. 이를 계기로 주술사 세계에 발을 들이게 된 유지는 저주받은 존재로서 살아남기 위해 싸운다. 그는 동료 주술사들과 함께 저주와 싸우며, 인간의 어두운 면과 저주가 만들어지는 근원을 탐구한다. 유지는 자신의 운명과 저주를 받아들이며, 세상과 자신을 구하기 위한 여정을 시작한다.",
      },
  ];